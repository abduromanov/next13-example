import { Button, HStack, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Stack, useDisclosure } from "@chakra-ui/react";
...
import { TMutasiSyirkahRequest, useCreateMutasiSyirkah } from "@/services/api/commands/syirkah.command";
...
const ModalCreateMutasiSyirkah = forwardRef<Partial<ReturnType<typeof useDisclosure>> | undefined, Props>((props, ref) => {
  ...
  const mutasiSyirkahMutation = useCreateMutasiSyirkah(router.query.id as string).mutate('POST');
