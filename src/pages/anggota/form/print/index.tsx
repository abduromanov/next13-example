...
export default function Page() {
  ...
  useEffect(() => {
    const formRequest: TFormRequest = JSON.parse(sessionStorage.getItem("requestData") || "");
    setData(formRequest);
    ...
    <Container maxW="container.lg" pt={8}>
      <Stack spacing={8}>
        <Stack spacing={2}>
          ...
          <Text maxW="50%" fontSize="sm">Jl. H. Rijin Kav. Iqra’ No. 196-A RT.01/RW.09 Jati makmur, Pondok Gede, Bekasi, Jawa Barat</Text>
        </Stack>

        <Box w="full">
          <Heading textAlign="center" mx="auto" maxW="85%">Permohonan dan Pengajuan Pembiayaan
            Koperasi Syariah Hamasah</Heading>
        </Box>
        ...
        <SimpleGrid columns={5} gap={2}>
          ...
          <GridItem colSpan={4}>
            : {data?.jangkaWaktu || 0} Bulan
          </GridItem>
        </SimpleGrid>

        <Text>Dengan pengajuan ini saya bersedia mentaati segala ketentuan dan peraturan yang berlaku di KOPERASI
          SYARIAH HAMASAH.
        </Text>
