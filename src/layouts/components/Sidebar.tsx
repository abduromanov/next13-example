import { Button, Drawer, DrawerBody, DrawerContent, DrawerOverlay, Flex, Icon, Text, VStack } from "@chakra-ui/react";
...
export default function Sidebar(props: Props) {
  return (
    <>
      <Flex px={6} py={8} bg={'brand.500'} minH={'full'} minW={'2xs'} maxW={'2xs'} pos={'fixed'}
        sx={{
          display: 'none',
      ...
      <Drawer placement="left" onClose={props.disclosure.onClose} isOpen={props.disclosure.isOpen}>
        <DrawerOverlay />
        <DrawerContent>
